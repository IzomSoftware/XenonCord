...
public class XenonCore {
    ...
    public void init(long startTime) {
        ...
        getTaskManager().async(() -> {
            ...
            try {
                HttpClient.get(new URL("https://api.github.com/repos/IzomSoftware/XenonCord/releases/latest")).get()
                        .forEach(
                                sb::append);
            ...
            System.out.println((Colorize.console(String.format(
                    ...
                    this.version))));
            getLogger().warn(
                    "!!!!! ATTENTION !!!!! if you want proxy lists downloaded from github to be updated, delete proxylist.txt in XenonCord folder.");
        });
    }
